...
const app=express();
app.get('/',(req,res)=>{
res.send('<!DOCTYPE html><html><head><title>LuaGuard v5.3</title><style>body{font-family:Arial;background:#0d1117;color:#c9d1d9;text-align:center;padding:50px}h1{color:#58a6ff}.ok{color:#3fb950;font-size:1.3em}.box{background:#161b22;padding:25px;border-radius:12px;max-width:450px;margin:25px auto;border:1px solid #30363d}ul{text-align:left;padding-left:20px}li{margin:8px 0}</style></head><body><h1>LuaGuard v5.3 Final</h1><p class="ok">● Online</p><div class="box"><p><b>Features:</b></p><ul><li>✅ 10 Variable Styles</li><li>✅ String Encoding (4 methods)</li><li>✅ Number Obfuscation (4 methods)</li><li>✅ Dead Code Injection</li><li>✅ Safe Wrapper</li></ul></div><p style="color:#8b949e">Delta Compatible</p></body></html>');
});
